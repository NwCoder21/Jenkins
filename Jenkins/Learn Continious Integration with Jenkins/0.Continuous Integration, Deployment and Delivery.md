...
Jenkins has now become an open source project. It is one of the most popular and continuously contributed projects that's available as open source which means you're always getting new features being added to it. It's a tool that really becomes the center the CI environment
