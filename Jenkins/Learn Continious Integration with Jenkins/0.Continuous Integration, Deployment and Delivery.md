...
The Jenkins server acts as a the master environment on the left hand side and that master environment can then push out to multiple other Jenkins slave environments to distribute the workload.
