...
The `Credentials` plugin allows us to create credentials in the Jenkins UI, and the `Credentials Binding` plugin  plugin that allows us to use those credentials in the Jenkinsfile through environmental variables.
...
This will make avaialble maven commands in all the stages within the Jenkinsfile. 
...
![image](https://user-images.githubusercontent.com/107522496/216314617-28c0ccf0-35d9-4537-9292-d4c462480d8e.png)
...
Note, if you do not have the `Build wih parameters`, you may have to download the below plugin ...
